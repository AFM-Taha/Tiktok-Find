...
const ProductManage = () => {
  ...
  // Product fetch
  const { data, isLoading, error, refetch }: any = useGetData(productGetURL);
  ...
  const {
    totalProducts,
    result: products,
  }: { totalProducts: number; result: [] } = data.data;
  ...
  return (
    <div className="text-gray-100">
      ...
      <h5 className="mt-4 text-lg "> Total Products : {totalProducts}</h5>
