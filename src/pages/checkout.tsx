        ...
        <div className="px-4 pt-8">
          ...
          <div className="mt-8 space-y-3 rounded-lg border bg-white px-2 py-4 sm:px-6">
            <div className="flex flex-col rounded-lg bg-white sm:flex-row">
              ...
              <div className="flex w-full flex-col px-4 py-4">
                ...
                <p className="text-lg font-bold text-black">$138.99</p>
              </div>
            </div>
            <div className="flex flex-col rounded-lg bg-white sm:flex-row">
              <Image
              ...
              <div className="flex w-full flex-col px-4 py-4">
                ...
                <span className="float-right text-gray-400">42EU - 8.5US</span>
                <p className="mt-auto text-lg font-bold text-black">$238.99</p>
              </div>
            </div>
          </div>
          ...
          <form className="mt-5 grid gap-6">
            <div className="relative">
              ...
              <label
                className="flex cursor-pointer select-none rounded-lg border border-gray-300 p-4 peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-700"
                htmlFor="radio_1">
                <FaFedex size={64} />
                <div className="ml-5">
